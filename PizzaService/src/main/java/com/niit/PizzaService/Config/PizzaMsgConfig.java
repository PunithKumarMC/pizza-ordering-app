...
@Configuration
public class PizzaMsgConfig {
    private String exchangeName="pizza_exchange";
    private String registerQueue="pizza_queue";
    ...
    {
        return BindingBuilder.bind(registerQueue()).to(directExchange()).with("pizza_routing");
    }
}
